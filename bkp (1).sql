...
CREATE TABLE `categoria` (
  `codCategoria` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cidade` (
  `codCidade` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
INSERT INTO `cidade` VALUES (4,'kdsjs');
...
CREATE TABLE `cliente` (
  ...
  `cidade_CodCidade` int(10) unsigned NOT NULL DEFAULT '0',
  `sexo` char(1) DEFAULT NULL,
  `endereco` varchar(60) DEFAULT NULL,
  `telefone` varchar(20) DEFAULT NULL,
  `cpf` varchar(25) DEFAULT NULL,
  `qtde_comprado` int(11) DEFAULT NULL,
...
INSERT INTO `cliente` VALUES (10,'Pedro',4,'M','uyuyuyu','0980-9','899.898',13),(11,'ana',4,'M','','','',152),(12,'teset',4,'M','','','',11),(13,'refs',4,'M','','','',25),(14,'autoridade',4,'M','','','',9),(16,'online',4,'M','','','',18),(17,'selec',4,'M','','','',3),(18,'lkj',4,'M','','','',0);
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `compra` (
  `codCompra` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `fornecedor_CodFornecedor` int(10) unsigned NOT NULL,
...
CREATE TABLE `contas_receber` (
  `codContas_receber` int(11) NOT NULL AUTO_INCREMENT,
  `venda_codVenda` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `editora` (
  `CodEditora` int(10) unsigned NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `forma_pg` (
  `cod_forma_pg` int(11) NOT NULL AUTO_INCREMENT,
  `tipo` varchar(120) DEFAULT NULL,
  `venda_codVenda` int(11) unsigned NOT NULL DEFAULT '0',
  `NumParcelas` int(11) unsigned DEFAULT NULL,
...
CREATE TABLE `fornecedor` (
  `codFornecedor` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `cidade_CodCidade` int(10) unsigned NOT NULL DEFAULT '0',
...
CREATE TABLE `itens_compra` (
  `compra_CodCompra` int(10) unsigned NOT NULL,
...
CREATE TABLE `livro` (
  ...
  `editora_CodEditora` int(10) unsigned NOT NULL,
  `categoria_CodCategoria` int(10) unsigned NOT NULL,
  `autor_CodAutor` int(10) unsigned NOT NULL,
  `qtde_vendido` int(10) unsigned DEFAULT NULL,
  `estoque_atual` int(10) unsigned DEFAULT NULL,
...
INSERT INTO `livro` VALUES (10,'liro redes',3,5,4,20,91,10,'1212-12-12',100.00,150.00,'sdjfsfdjsdlldks','java2.jpg',NULL),(11,'oracle',3,5,4,19,61,10,'1212-12-01',990.00,98.00,',sd,n,','ubuntu1.jpg',NULL),(12,'aaaa',3,5,4,82,0,8,'1212-12-12',78.00,8.00,'','ubuntu1.jpg',NULL),(13,'liro',3,5,4,3,18,12112,'1212-12-12',1221.00,12.00,'jlkaldlkaj','sql1.jpg',NULL);
...
INSERT INTO `venda` VALUES (60,11,'2012-07-03',98.00,0.00),(61,11,'2012-07-04',256.00,0.00),(62,10,'2012-07-04',248.00,0.00),(64,13,'2012-07-05',354.00,100.00),(65,11,'2012-07-05',98.00,0.00),(66,14,'2012-07-05',150.00,0.00),(67,12,'2012-07-05',196.00,0.00),(68,14,'2012-07-05',308.00,0.00),(69,16,'2012-07-10',264.00,0.00),(70,13,'2012-07-10',764.00,0.00),(71,10,'2012-07-10',8.00,0.00),(72,12,'2012-07-10',458.00,0.00),(73,11,'2012-07-11',24.00,0.00),(74,17,'2012-07-11',196.00,0.00),(75,16,'2012-07-11',256.00,0.00),(76,11,'2019-10-29',568.00,0.00),(77,11,'2019-10-29',8.00,0.00);
...
BEGIN
    ...
    /*insert into cliente (cidade_codcidade,nome_cliente,telefone) values (1,'procedure',qtd);*/
...
-- Dump completed on 2019-10-29 13:36:57
