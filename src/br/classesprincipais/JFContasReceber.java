 ...
 * @author Semp
 */
public class JFContasReceber extends javax.swing.JFrame {

    private Conexao con = new Conexao();
    private String codVenda,codCliente;
    //armazena o codigo da venda selecionado na grid 1
    private String selecionado;
    private String codContasReceber;
    
    //verifica se a situaçao da conta a recer é aberto ou quitada
    private int situacao=1;
    
    public JFContasReceber() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código Venda", "Cliente", "Total da Venda", "Data da Venda", "Situação"
            }
        ));
        ...
        jTcodVenda.setBackground(new java.awt.Color(102, 204, 255));
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addComponent(jTcodVenda, javax.swing.GroupLayout.PREFERRED_SIZE, 66, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel4)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jTDataVenda, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       try
       {
           ...
           con.executaSql("select quitada from parcelas "+ 
                        " inner join contas_receber  on (contas_receber.codContas_receber = parcelas.cod_contas_receber)"+ 
                        " inner join venda on (venda.codVenda = contas_receber.venda_codVenda)"+
                        " where contas_receber.venda_codVenda =  "+selecionado);
           ...
           if(confirma==true)
           {
               ...
               con.conecta();
               con.executaSql("update contas_receber set situacao='quitada' where venda_codVenda = "+selecionado);
               con.getPs().execute();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try
        {
            ...
            if(i==0)
            {
                ...
                con.executaSql("delete from parcelas where cod_contas_receber = "+codContasReceber);
                con.getPs().execute();
                
                con.executaSql("delete from contas_receber where venda_codVenda = "+selecionado);
                con.getPs().execute();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                new JFContasReceber().setVisible(true);
            }
        });
    }
    ...
    public void atualizaTables()
    {
         try
        {
            ...
            jTcodVenda.setText(selecionado);
            jTcliente.setText(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(),1)));
            jTtotal.setText(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(),2)));
            jTDataVenda.setText(String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(),3)));
            String situacao = String.valueOf(jTable1.getValueAt(jTable1.getSelectedRow(),4));

            con.conecta();
            con.executaSql("select p.num_parcelas,codContas_receber  from parcelas p "
                    + " inner join contas_receber cr on (p.cod_contas_receber = cr.codContas_receber)"
                    + " where cr.venda_codVenda = "+selecionado);
            con.getRs().next();
            int numParcelas  =Integer.parseInt(con.getRs().getString("num_parcelas"));
            codContasReceber = con.getRs().getString("codContas_receber");
            con.getRs().first();
            ...
            con.executaSql("select *  from parcelas p "
                    + " inner join contas_receber cr on (p.cod_contas_receber = cr.codContas_receber)"
                    + " where cr.venda_codVenda = "+selecionado);
    ...
    public void preenchejTable(String estado)
    {
        try
        {
           ...
           sql = "select * from venda "
                + " inner join contas_receber  on(contas_receber.venda_codVenda = venda.codVenda)  "
                + " inner join cliente  on (cliente.codCliente = venda.cliente_CodCliente)"
                + " where situacao = "+estado+" order by venda.codVenda desc "; 
            ...
            while(con.getRs().next())
            {
                ...
                modelo.addRow(new Object[]{con.getRs().getString("codVenda"),con.getRs().getString("nome_cliente"),
                    con.getRs().getString("valor_total"),con.getRs().getString("data_venda"),con.getRs().getString("situacao")
                });
